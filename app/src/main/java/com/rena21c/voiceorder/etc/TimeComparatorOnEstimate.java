...
public class TimeComparatorOnEstimate implements Comparator<String> {

    HashMap<String, Reply> replyHashMap;

    public TimeComparatorOnEstimate(HashMap<String, Reply> replyHashMap) {
    ...
    @Override public int compare(String o1, String o2) {
        ...
        if(replyRateOfReply1 < replyRateOfReply2) {
            ...
            if(reply1.timeMillis > reply2.timeMillis) return -1;
            else if(reply1.timeMillis == reply2.timeMillis) return 0;
            else return 1;
        } else return -1;
    }
}
